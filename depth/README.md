...
![Gradient norm by layer at depth 40, and accuracy by depth, for four configurations](image.png)
...
[Part 2](../finding-the-weights/) ended on a claim: the bottleneck in these models was never what they
...
([`src/gradient_flow.py`](src/gradient_flow.py)):
...
([`src/ablation.py`](src/ablation.py), about ten minutes):
...
Backpropagation was in print in 1970 ([Part 2](../finding-the-weights/)). Depth started working around
