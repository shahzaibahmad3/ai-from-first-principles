...
What he couldn't do was TRAIN them. That reason is worth sitting with.
...
So I ran it. Same 9-parameter network whose exact solution I just wrote down. 300 random starts, 20,000 epochs each, four hidden widths — 1,200 training runs:
...
Playground (bend the surface yourself, then re-roll the init until it fails), write-up and code — every number reproducible: [link in comments]
